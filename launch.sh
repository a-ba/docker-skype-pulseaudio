...
# run the container
ctr="`$DOCKER_CMD run -d -p 55555:22 -v "$PWD/$TMP_KEY.pub:/home/docker/.ssh/authorized_keys:ro" -v "$PWD/$TMP_COOKIE:/home/docker/.pulse-cookie" "$DOCKER_IMAGE"`"
...
# run skype via ssh
ssh -X -a -i "$TMP_KEY" -R 64713:127.0.0.1:4713 -l docker -p 55555 127.0.0.1 skype-pulseaudio
